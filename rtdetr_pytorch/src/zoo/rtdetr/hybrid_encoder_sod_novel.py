...
__all__ = ['HybridEncoderNovelCoordGnConv']
...
class CSPCoordGnLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 act="silu",
                 reduction=4):
        super(CSPCoordGnLayer, self).__init__()
...
@register
class HybridEncoderNovelCoordGnConv(nn.Module):
    def __init__(self,
        ...
        # top-down fpn - USING CoordGnConv
